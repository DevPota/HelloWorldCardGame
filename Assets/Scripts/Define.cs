public static class Define
{
    ...
    public const int BGM_CREDIT = 3;

    public const int UI_BUTTON_CLICK_SFX = 0;
    public const int UI_BUTTON_SELECT_FIRST_SFX = 1;
    ...
    public const string SCENE_RESULT_STR = "ResultScene_Additive";
    public const string SCENE_CREDIT_STR = "CreditScene";
}
